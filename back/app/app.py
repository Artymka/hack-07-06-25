...
async def test_model_answers(text):
    if text.lower().startswith("проанализируй данные о населении и заработной плате в муниципалитетах ростовской области"):
        ...
        yield """Муниципалитеты Ростовской области, где зафиксированы наиболее высокие средние расходы граждан на маркетплейсы (рассчитанные на одного жителя), представлены следующим списком в порядке убывания:
